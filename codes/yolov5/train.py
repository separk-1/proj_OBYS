...
def parse_opt(known=False):
    ...
    parser.add_argument('--data', type=str, default='/home/obayashi/data/cctv_video/train_data/data.yaml', help='dataset.yaml path')
    ...
    parser.add_argument('--project', default='/home/obayashi/Projects/proj_obayashi/results/train_result', help='save to project/name')
